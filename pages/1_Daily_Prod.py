...
if uploaded_file:
    ...
    if "Status" in df.columns and "Remark By" in df.columns:
        ...
        def process_campaign_split(master_path, tmpl_path, save_dir, date_str, bucket_list, password):
            ...
            try:
                ...
                for b in bucket_list:
                    ...
                    campaign_tmpl = fr"C:\\Users\\SPM\\Downloads\\BPI\\Template\\PL_2026{{Month}}{{Day}}_{{Campaign}}_Madridv1.xlsx"
        ...
        internal_master_name = f"Master_Calculation_{date_str}Test{tmpl_ext}v1"
